...
export const platformSettings = pgTable('platform_settings', {
  ...
  masterclassesEnabled: boolean('masterclasses_enabled').notNull().default(false),
  digitalProductsEnabled: boolean('digital_products_enabled').notNull().default(false),
  ...
  digitalProductsLaunched: boolean('digital_products_launched').notNull().default(false),
  masterclassesLaunched: boolean('masterclasses_launched').notNull().default(false),
...
export const masterclassCertificateSettings = pgTable(
  'masterclass_certificate_settings',
  {
    ...
    certificateTitleEn: text('certificate_title_en'),
    certificateTitleAr: text('certificate_title_ar'),
    certificateDescription: text('certificate_description'),
    certificateDescriptionEn: text('certificate_description_en'),
    certificateDescriptionAr: text('certificate_description_ar'),
