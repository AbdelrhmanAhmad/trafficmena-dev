...
| [series-pricing-and-sales.md](./series-pricing-and-sales.md#إصلاح-إضافي-جلسة-سابقة-drizzle-studio-على-windows) | إصلاح Drizzle Studio على Windows (ضمن نفس المستند) |
| [fawaterk-payment-invoice-id-fix.md](./fawaterk-payment-invoice-id-fix.md) | إصلاح Fawaterk: UUID لـ `invoice_id` + `getInvoiceData` + verify الاشتراك + redirect |
...
- **2026-06-10** — Series pricing & sales toggle
