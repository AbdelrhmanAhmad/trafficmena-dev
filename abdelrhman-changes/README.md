...
| [event-track-recordings-access.md](./event-track-recordings-access.md) | **Publish Recordings للبيع** من Track + CTA للحاجزين (بدون تمديد حجز) |
...
- `0024_module_settings.sql`

## آخر تحديث

- **2026-08-04** — Publish Recordings for sale من أدمن Track (بدون تمديد حجز) + CTA للحاجزين
