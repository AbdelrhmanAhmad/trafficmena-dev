      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              The premier digital marketing community in the MENA region. Connect, learn, and grow with industry professionals through our meetups and resources.
            </p>
            <div className="flex space-x-4">
              {/* Social Media Icons with Security Attributes */}
              <a 
                href="https://x.com/trafficmena" 
                className="text-gray-300 hover:text-primary-green transition-colors duration-200"
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/meetups" className="text-gray-300 hover:text-primary-green transition-colors duration-200">Meetups</Link></li>
              <li><Link to="/about" className="text-gray-300 hover:text-primary-green transition-colors duration-200">About Us</Link></li>
            </ul>
          </div>

          {/* Support */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-primary-green">Support</h3>
            <ul className="space-y-2">
              <li><Link to="/contact" className="text-gray-300 hover:text-primary-green transition-colors duration-200">Contact</Link></li>
              <li><Link to="/help" className="text-gray-300 hover:text-primary-green transition-colors duration-200">Help Center</Link></li>
              <li><Link to="/privacy" className="text-gray-300 hover:text-primary-green transition-colors duration-200">Privacy Policy</Link></li>
              <li><Link to="/terms" className="text-gray-300 hover:text-primary-green transition-colors duration-200">Terms of Service</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-300">
            © 2024 TrafficMENA. All rights reserved. | Digital Marketing Community for the MENA Region
          </p>
        </div>
      </div>
    </footer>
