  ...
  return (
    <Layout>
      <div className="relative isolate overflow-hidden">
        ...
        <div className="pointer-events-none absolute -right-[45vw] bottom-[-30vh] -z-10 h-[50vh] w-[75vw] rounded-full bg-gradient-to-tr from-[#00fdc2]/25 via-[#05ef62]/20 to-transparent blur-[90px]" />
