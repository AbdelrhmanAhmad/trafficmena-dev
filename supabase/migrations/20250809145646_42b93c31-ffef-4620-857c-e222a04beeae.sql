-- Enhanced security measures for profiles table - Fixed version
...
-- 4. Strengthen existing RLS policies with additional checks
DROP POLICY IF EXISTS "Users can view their own profile" ON public.profiles;
DROP POLICY IF EXISTS "Users can update their own profile" ON public.profiles;

-- Enhanced user profile access policy
...
-- 6. Create view for safe profile access with data masking
